...
public class NameNodeHttpServer {
  ...
  void start() throws IOException {
     ...
     *
     * Hadoop  喜欢自己封装东西 。
     * 举个例子 本来就有 RPC 服务，但是 hadoop 自己封装了一个 Hadoop RPC
     * 这个地方类似 本来有 httpServer 服务 ，hadoop 封装了自己的 httpServer2 服务
     *
     */
    ...
    //绑定了多个servlet  listPaths
    //TODO setupServlets

    //TODO httpServerRpc hadoopRpc 哪种情况下使用哪个
  ...
  private static void setupServlets(HttpServer2 httpServer, Configuration conf) {
    ...
    //TODO 我们可以在 50070 界面上浏览目录信息 就是因为这个 servlet
    // http://hadoop102:50070/listpaths/?path=/
